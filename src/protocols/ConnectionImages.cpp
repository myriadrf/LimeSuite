...
static const ConnectionImageEntry &lookupImageEntry(const LMS64CProtocol::LMSinfo &info)
{
    static const std::vector<ConnectionImageEntry> imageEntries = {
        ...
        ConnectionImageEntry({LMS_DEV_LIMESDR, 4, 4, "LimeSDR-USB_HW_1.4_r4.0.img", 2, 20,  "LimeSDR-USB_HW_1.4_r2.20.rbf"}),
        ...
        ConnectionImageEntry({LMS_DEV_LIMENET_MICRO, 3, 0, nullptr,  1, 1,  "LimeNET-Micro_lms7_trx_HW_2.1.rpd"}),
        ConnectionImageEntry({LMS_DEV_LIMESDRMINI,  0, 0, nullptr,  1, 29,  "LimeSDR-Mini_HW_1.2_r1.29.rpd"}),
    };
