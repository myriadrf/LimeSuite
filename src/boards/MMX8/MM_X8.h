...
class LimeSDR_MMX8 : public lime::SDRDevice
{
  public:
    ...
    virtual int MemoryWrite(eMemoryDevice device, uint8_t moduleIndex, uint32_t address, const void* data, size_t length) override;
    virtual int MemoryRead(eMemoryDevice device, uint8_t moduleIndex, uint32_t address, void* data, size_t length) override;
