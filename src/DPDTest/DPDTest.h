...
protected:
    ...
    int readstream_qspark(char *buffer, int bytesToRead);
    int openstream_qspark();
    int closestream_qspark();
    ...
    void prepare_train2();
    int readdata_qspark();
    int readdata_qspark2();
    int readdata();
    int readdata2();

    void InterpolationByTwo(int numSamples, double *x, int filtN, double *filtH, double filtG, double *y);
    void InterpolationByFour(int numSamples, double *xi, double *xq, double *yi, double *yq);
    void CheckDiscontinuity();
