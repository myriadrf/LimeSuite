...
//, m_timer(this, TIMER_ID)
{
	...
	//StaticText_1 = new wxStaticText(m_ADPD_tabSpectrum, ID_STATICTEXT_1, _T("FFT samples count:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_1"));
	//m_ADPD_controlsSizer3->Add(StaticText_1, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL, 2);
	//m_ADPD_FFTSamples = new wxTextCtrl(m_ADPD_tabSpectrum, ID_TEXTCTRL_FFTSAMPLES, _T("16384"), wxDefaultPosition, wxSize(60, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL_ADPD1"));
	//m_ADPD_FFTSamples->SetExtraStyle(m_ADPD_FFTSamples->GetExtraStyle() | wxWS_EX_BLOCK_EVENTS);
	//m_ADPD_controlsSizer3->Add(m_ADPD_FFTSamples, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL, 2);
	...
	//StaticBoxSizerADPD4 = new wxStaticBoxSizer(wxVERTICAL, m_ADPD_tabSpectrum, _T(""));
	//m_ADPD_controlsSizer4 = new wxFlexGridSizer(0, 2, 0, 0);
	//m_ADPD_controlsSizer4->AddGrowableCol(0);
	//m_ADPD_controlsSizer4->AddGrowableRow(0);
	//StaticBoxSizerADPD4->Add(m_ADPD_controlsSizer4);
	//btnCalculateFFT = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_CALFFT, _T("Run QADPD"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_CALFFT"));
	//m_ADPD_controlsSizer3->Add(btnCalculateFFT, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	//Connect(ID_BUTTON_CALFFT, wxEVT_COMMAND_BUTTON_CLICKED, (wxObjectEventFunction)&DPDTest::OnbtnCalculateFFT);

	m_ADPD_controlsSizer->Add(StaticBoxSizerADPD3);
	//m_ADPD_controlsSizer->Add(StaticBoxSizerADPD4);	
	/////////////////////////////////////////////
	...
	m_ADPD_controlsSizer->Add(StaticBoxSizerADPD1);
	...
	StaticText_ADPD1 = new wxStaticText(m_ADPD_tabSpectrum, ID_STATICTEXT_ADPD1, _T("M (nonlinearity):"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_ADPD1"));
	...
	//StaticText_ADPD4 = new wxStaticText(m_ADPD_tabSpectrum, ID_STATICTEXT_ADPD8, _T("Am=2**(b-1), b:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_ADPD8"));
	//m_ADPD_controlsSizer2->Add(StaticText_ADPD4, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL, 2);
	//m_ADPD_txtAm = new wxSpinCtrl(m_ADPD_tabSpectrum, ID_TEXTCTRL_ADPD3, _T("18"), wxDefaultPosition, wxSize(60, -1), 0, 0, 24, 2, _T("ID_TEXTCTRL_ADPD3"));
    //m_ADPD_txtAm->SetValue(_T("18"));
	//m_ADPD_controlsSizer2->Add(m_ADPD_txtAm, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL, 2);

	//StaticText_ADPD5 = new wxStaticText(m_ADPD_tabSpectrum, ID_STATICTEXT_ADPD9, _T("x(n) delay:"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT_ADPD9"));
	//m_ADPD_controlsSizer2->Add(StaticText_ADPD5, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	//m_ADPD_txtSkip = new wxTextCtrl(m_ADPD_tabSpectrum, ID_TEXTCTRL_ADPD4, _T("1024"), wxDefaultPosition, wxSize(60, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL_ADPD4"));
	//m_ADPD_txtSkip->SetExtraStyle(m_ADPD_txtSkip->GetExtraStyle() | wxWS_EX_BLOCK_EVENTS);
	//m_ADPD_controlsSizer2->Add(m_ADPD_txtSkip, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
	...
	//CheckBox_YPFPGA = new wxCheckBox(m_ADPD_tabSpectrum, ID_CHECKBOX_YPFPGA, _T("Yp from FPGA"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX_YPFPGA"));
	//CheckBox_YPFPGA->SetValue(true);
	//m_ADPD_controlsSizer2->Add(CheckBox_YPFPGA, 1, wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL | wxEXPAND | wxALL, 2);
	...
	m_ADPD_controlsSizer5 = new wxFlexGridSizer(0, 2, 0, 0);
	...
	Button_START = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_START, _T("Start"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_START"));
	...
	Button_END = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_END, _T("End"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_END"));
	...
	m_ADPD_controlsSizer6 = new wxFlexGridSizer(0, 2, 0, 0);
	...
	btnCapture = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_CAPTURE, _T("Read"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_CAPTURE"));
	...
	Button_TRAIN = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_TRAIN, _T("Train"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_TRAIN"));
	...
	Button_SEND = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_SEND, _T("Send coeff."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_SEND"));
	...
	Button_TIMER = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_TIMER, _T("Reset coeff."), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_BUTTON_TIMER"));
	...
	Button_RTS = new wxButton(m_ADPD_tabSpectrum, ID_BUTTON_RTS, _T("Read, train, send"), wxDefaultPosition, wxSize(120, -1), 0, wxDefaultValidator, _T("ID_BUTTON_RTS"));
	...
	m_ADPD_Num = new wxTextCtrl(m_ADPD_tabSpectrum, ID_TEXTCTRL_NUM, _T("1"), wxDefaultPosition, wxSize(40, -1), 0, wxDefaultValidator, _T("ID_TEXTCTRL_NUM"));
	...
	m_MainTabs->AddPage(m_ADPD_tabSpectrum, _T("QADPD"), false);
...
void DPDTest::SaveConfig()
{
	...
	QADPD_AM = 12; // m_ADPD_txtAm->GetValue(); 

	QADPD_SKIP = 0;
	//m_ADPD_txtSkip->GetValue().ToLong(&temp);
	//if ((temp >= 0) && (temp <= 20480)) QADPD_SKIP = (int)temp;
	//else {
	//	QADPD_SKIP = 0;
	//	m_ADPD_txtSkip->SetValue("0");
	//}
...
void DPDTest::OnbtnStartClick(wxCommandEvent& event)
{
	...
	QADPD_M = spin_ADPD_M->GetValue();
	QADPD_ND = spin_ADPD_Delay->GetValue();	
	QADPD_AM = 12; // m_ADPD_txtAm->GetValue(); // (1 << (QADPD_AM-1));
	...
	//Button_RTS->Enable(true);
	//CheckBox_YPFPGA->Enable(false);
	//btnCalculateFFT->Enable(true);
	//btnCapture->Enable(true);
	//Button_TIMER->Enable(true);
...
int DPDTest::train(){
	...
	// toliko se preskace pa se onda radi train();
	Qadpd->skiping += 100;

	//if (QADPD_YPFPGA == true) Qadpd->skiping += QADPD_SKIP; 
	// podesava se naknadno, uracunava se kasnjenje predistortera
	QADPD_YPFPGA = true;
	...
	int temp = 0;
	temp=Qadpd->update_coeff();
	// prebacivanje iz a_ u a, tj. iz b_ u b
	// provera da li su svi koeficijenti u granici [-4, 4]
	// run_QADPD();
...
void DPDTest::send_coef(){
	...
	// opseg brojeva je od[-4 do 4 - lsb]
    // 0x2000 = 0010 0000 0000 0000  predstavlja jedinicu

	double am = 8192.0;  // skaliranje
	int temp = 0;
	...
	for (i = 0; i <= 5; i++)  // bilo je 3
		for (j = 0; j <= 3; j++){
			...
			for (int k = 0; k <= LIM; k++)  SPI_write(mDataPort, 0x0016, tempsh); //spi_data <= a(i)(j);
...
{	
	...
	if (m_ADPDControls->ShowModal() == wxID_OK) {
		...
		//m_iCenterFreqRatioPlot1 = m_ADPDControls->m_iCenterFreqRatio;
		//m_iFreqSpanRatioPlot1 = m_ADPDControls->m_iFreqSpanRatio;
		//m_dCenterFreqRatioPlot1 = m_ADPDControls->m_dCenterFreqRatio;
		//m_dFreqSpanRatioPlot1 = m_ADPDControls->m_dFreqSpanRatio;
...
void DPDTest::OnbtnPlot2ControlsClick(wxCommandEvent& event)
{
	...
	if (m_ADPDControls->ShowModal() == wxID_OK) {
		...
		//m_iCenterFreqRatioPlot2 = m_ADPDControls->m_iCenterFreqRatio;
		//m_iFreqSpanRatioPlot2 = m_ADPDControls->m_iFreqSpanRatio;
		//m_dCenterFreqRatioPlot2 = m_ADPDControls->m_dCenterFreqRatio;
		//m_dFreqSpanRatioPlot2 = m_ADPDControls->m_dFreqSpanRatio;
...
void DPDTest::OnbtnPlot3ControlsClick(wxCommandEvent& event)
{
	...
	if (m_ADPDControls->ShowModal() == wxID_OK) {
		...
		//m_iCenterFreqRatioPlot3 = m_ADPDControls->m_iCenterFreqRatio;
		//m_iFreqSpanRatioPlot3 = m_ADPDControls->m_iFreqSpanRatio;
		//m_dCenterFreqRatioPlot3 = m_ADPDControls->m_dCenterFreqRatio;
		//m_dFreqSpanRatioPlot3 = m_ADPDControls->m_dFreqSpanRatio;
...
void DPDTest::OnbtnPlot4ControlsClick(wxCommandEvent& event)
{
	...
	if (m_ADPDControls->ShowModal() == wxID_OK) {
		...
		//m_iCenterFreqRatioPlot4 = m_ADPDControls->m_iCenterFreqRatio;
		//m_iFreqSpanRatioPlot4 = m_ADPDControls->m_iFreqSpanRatio;
		//m_dCenterFreqRatioPlot4 = m_ADPDControls->m_dCenterFreqRatio;
		//m_dFreqSpanRatioPlot4 = m_ADPDControls->m_dFreqSpanRatio;
...
void DPDTest::changePlotType(OpenGLGraph * graph, int plotType, int  m_iXaxisLeftPlot, int m_iXaxisRightPlot) {
	...
	case 0: // Time domain
		...
		//graph->AddSerie(new cDataSerie());
		//graph->AddSerie(new cDataSerie());
		//graph->AddSerie(new cDataSerie());
		//graph->AddSerie(new cDataSerie());
		graph->SetInitialDisplayArea(m_iXaxisLeftPlot, m_iXaxisRightPlot, -2048, 2048);
	...
	case 1: // I versors Q
		...
		graph->series[2]->color = 0x0000FFFF;
		graph->series[3]->color = 0x2F2F2FFF;
		graph->SetInitialDisplayArea(-2048, 2048, -2048, 2048);
...
void DPDTest::run_QADPD(){
	...
	for (int i = 3; i < samplesReceived-3; i++) {
		...
		if (QADPD_YPFPGA == false) {
			// overwrite yp data
			//yp_samples[i].r = Qadpd->ypi;
			//yp_samples[i].i = Qadpd->ypq;
		}
	}
	...
	wxString temps1;
	//if ((QADPD_FFTSAMPLES > samplesReceived) && (samplesReceived>0)) {
	//	QADPD_FFTSAMPLES = samplesReceived;
	//	temps1.Printf(_T("%d"), QADPD_FFTSAMPLES);
	//	m_ADPD_FFTSamples->SetValue(temps1);
	//}
...
void DPDTest::readdata_qspark() //(wxCommandEvent& event)
{
	...
	if (bytesReceived > 0)
	{
		...
		for (int i = 0; i < samplesToRead; ++i)
		{
			...
			yp1_samples[index].i = yp_samples[index].i;	// Borko, 11.09.2016
			bitOffset += bitsInSample;

			//yp q
			yp_samples[index].r = ReadBitStream(buffer, bitOffset, bitsInSample, true);
			
			yp1_samples[index].r = yp_samples[index].r;	// Borko, 11.09.2016
			bitOffset += bitsInSample;

			//xp i
			xp_samples[index].i = ReadBitStream(buffer, bitOffset, bitsInSample, true);
			
			xp1_samples[index].i = xp_samples[index].i;	// Borko, 11.09.2016
			bitOffset += bitsInSample;
			//xp q
			xp_samples[index].r = ReadBitStream(buffer, bitOffset, bitsInSample, true);
			
			xp1_samples[index].r = xp_samples[index].r;	// Borko, 11.09.2016
			bitOffset += bitsInSample;
			--index;
		}
		...
		PlotFFT(mFFT_xp, fftCalcOut, samplesReceived, mNyquist_Hz / 1e6);
		//calculate yp FFT
		kiss_fft(m_fftCalcPlan, yp_samples, fftCalcOut);
		PlotFFT(mFFT_yp, fftCalcOut, samplesReceived, mNyquist_Hz / 1e6);
		//calculate x FFT
		kiss_fft(m_fftCalcPlan, x_samples, fftCalcOut);
		PlotFFT(mFFT_x, fftCalcOut, samplesReceived, mNyquist_Hz / 1e6);
		//free allocated memory
		kiss_fft_free(m_fftCalcPlan);
		delete xp_samples;
		delete yp_samples;
...
void DPDTest::readdata()  {
    ...
    if (bytesReceived > 0)
    {
        ...
        samplesReceived = bytesReceived / 9; //one sample, 3 bytes * 3 channels
        //allocate memory for FFT
        ...
        {   
			...
			//value = value / 2; // dodato novo
            xp_samples[index].r = value;
			xp1_samples[index].r = value;
        ...
        for (int i = samplesReceived*3*2; i < bytesReceived;  i+=3)
        {
			...
			// dodato novo
			value = (int16_t)(((double)value)* QADPD_GAIN);
			// mnozenje pojacanjem

            x_samples[index].r = value;
			x1_samples[index].r = value;
			
			y_samples[index].r = 0;  // dodato, privremeno 
			y1_samples[index].r = 0;  // dodato, privremeno 
			error_samples[index].r = 0;  // dodato, privremeno
			u_samples[index].r = 0;  // dodato, privremeno
			...
			x1_samples[index].i = value;
			
			y_samples[index].i = 0;  // dodato, privremeno
			y1_samples[index].i = 0;  // dodato, privremeno
			error_samples[index].i = 0;  // dodato, privremeno			
			u_samples[index].i = 0;  // dodato, privremeno
	...
	//for (int i = QADPD_SKIP; i < samplesReceived; i++) {
	//	x_samples[i - QADPD_SKIP].i = x_samples[i].i;
	//	x_samples[i - QADPD_SKIP].r = x_samples[i].r;
	//}	
}
*/
...
/*
uint16_t DPDTest::SPI_read(lime::IConnection * dataPort, uint16_t address) // //  LMScomms
{
...
wxString DPDTest::PlotIQ(OpenGLGraph* plot, int m_iValue)
{
	...
	vector <float> zeroes;
	zeroes.resize(samplesCount, 0);
	for (int i = 0; i < samplesCount; ++i) zeroes[i] = 3000.0;
