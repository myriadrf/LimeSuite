...
class CommsMock : public IComms
{
  public:
    ...
    MOCK_METHOD(int, GPIODirRead, (std::byte * buffer, const size_t bufLength), (override));
    MOCK_METHOD(int, GPIORead, (std::byte * buffer, const size_t bufLength), (override));
    MOCK_METHOD(int, GPIODirWrite, (const std::byte* buffer, const size_t bufLength), (override));
    MOCK_METHOD(int, GPIOWrite, (const std::byte* buffer, const size_t bufLength), (override));
    ...
    MOCK_METHOD(int,
        ProgramWrite,
        (const std::byte* data, size_t length, int prog_mode, int target, ProgressCallback callback),
        (override));
