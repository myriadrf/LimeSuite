...
class LIME_API LMS7002M
{
  public:
    ...
    LMS7002M(std::shared_ptr<lime::ISPI> port);
     ...
     */
    void SetConnection(std::shared_ptr<lime::ISPI> port);

    std::shared_ptr<lime::ISPI> GetConnection(void) const { return controlPort; }
