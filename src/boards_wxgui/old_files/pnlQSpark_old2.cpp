...
pnlQSpark::pnlQSpark(LMS7SuiteAppFrame * parent, wxWindowID id, const wxString &title, const wxPoint& pos, const wxSize& size, int style, wxString name)
{
	...
	pasw_choices1.push_back(_("RF1->RFC (J20)"));
	pasw_choices1.push_back(_("RF2->RFC (J22)"));
	
	wxArrayString pasw_choices2;
	pasw_choices2.push_back(_("Off"));
	pasw_choices2.push_back(_("RF1->RFC (J23)"));
	pasw_choices2.push_back(_("RF2->RFC (J25)"));
	...
	pamo_choices.push_back(_("Power down"));
	pamo_choices.push_back(_("Standby"));
	pamo_choices.push_back(_("Low Pwr (<7 dBm)"));
	pamo_choices.push_back(_("Med. Pwr(7-17 dBm)"));
	pamo_choices.push_back(_("High Pwr(17-28.6 dBm"));
	...
	rf_choices.push_back(_("Ext.RF1(J26)"));
	rf_choices.push_back(_("PA1 coupler out"));
	rf_choices.push_back(_("Ext.RF2(J27)"));
	rf_choices.push_back(_("PA2 coupler out"));
	...
	wxFlexGridSizer* paSizer = new wxFlexGridSizer(0, 4, 0, 0);
	paSizer->Add(new wxStaticText(this, wxID_ANY, _("PA1 switch:")), 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	paSizer->Add(cmbPa1Sw, 1, wxALIGN_LEFT | wxEXPAND, 5);
	paSizer->Add(new wxStaticText(this, wxID_ANY, _(" mode:")), 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	paSizer->Add(cmbPa1Mo, 1, wxALIGN_LEFT | wxEXPAND, 5);
	paSizer->Add(new wxStaticText(this, wxID_ANY, _("PA2 switch:")), 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	paSizer->Add(cmbPa2Sw, 1, wxALIGN_LEFT | wxEXPAND, 5);
	paSizer->Add(new wxStaticText(this, wxID_ANY, _(" mode:")), 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
	paSizer->Add(cmbPa2Mo, 1, wxALIGN_LEFT | wxEXPAND, 5);
	paSizer->Add(new wxStaticText(this, wxID_ANY, _("RF switch:")), 1, wxALL | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
