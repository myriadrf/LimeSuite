...
lms7002_pnlRXTSP_view::lms7002_pnlRXTSP_view(wxWindow *parent, wxWindowID id, const wxPoint &pos,
    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    cmbDTHBIT_RX = new wxComboBox(sbSizer106->GetStaticBox(), ID_DTHBIT_RX, wxEmptyString,
    ...
    cmbDCCORR_AVG = new wxComboBox(sbSizer134->GetStaticBox(), ID_DCCORR_AVG, wxEmptyString,
    ...
    cmbHBD_OVR_RXTSP = new wxComboBox(sbSizer99->GetStaticBox(), ID_HBD_OVR_RXTSP, wxEmptyString,
                                      wxDefaultPosition, wxSize(-1, -1), 0, NULL, 0);
    ...
    cmbGFIR1_L_RXTSP = new wxComboBox(sbSizer100->GetStaticBox(), ID_GFIR1_L_RXTSP, wxEmptyString,
                                      wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbGFIR2_L_RXTSP = new wxComboBox(sbSizer101->GetStaticBox(), ID_GFIR2_L_RXTSP, wxEmptyString,
                                      wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbGFIR3_L_RXTSP = new wxComboBox(sbSizer102->GetStaticBox(), ID_GFIR3_L_RXTSP, wxEmptyString,
                                      wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    // Connect Events
    chkEN_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL,
                         this);
    chkDC_BYP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                             wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    chkDC_LOOP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    chkGC_BYP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                             wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    chkPH_BYP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                             wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    chkCMIX_BYP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                               wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                               NULL, this);
    chkAGC_BYP_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    chkGFIR1_BYP_RXTSP->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
    ...
    chkGFIR3_BYP_RXTSP->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
    chkBSTART_RXTSP->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED,
                             wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    btnReadBIST->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnReadBISTSignature), NULL,
                         this);
    chkCAPSEL_ADC_RXTSP->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
    ID_BUTTON1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnReadRSSI), NULL, this);
    rgrSEL0->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                     wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                     this);
    txtFCWPHO0->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL01->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO01->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL02->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO02->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL03->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO03->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL04->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO04->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL05->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO05->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL06->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO06->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL07->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO07->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL08->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO08->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL09->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO09->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL10->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO10->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL11->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO11->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL12->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO12->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL13->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO13->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL14->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO14->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    rgrSEL15->Connect(wxEVT_COMMAND_RADIOBUTTON_SELECTED,
                      wxCommandEventHandler(lms7002_pnlRXTSP_view::OnNCOSelectionChange), NULL,
                      this);
    txtFCWPHO15->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                         wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged), NULL, this);
    btnUploadNCO->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnUploadNCOClick), NULL,
                          this);
    rgrMODE_RX->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL,
                        this);
    txtFCWPHOmodeAdditional->Connect(
        wxEVT_MOUSEWHEEL,
        wxMouseEventHandler(lms7002_pnlRXTSP_view::txtFCWPHOmodeAdditional_OnMouseWheel), NULL,
        this);
    txtFCWPHOmodeAdditional->Connect(wxEVT_COMMAND_TEXT_UPDATED,
                                     wxCommandEventHandler(lms7002_pnlRXTSP_view::PHOinputChanged),
                                     NULL, this);
    cmbDTHBIT_RX->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                          wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                          NULL, this);
    chkTSGSWAPIQ_RXTSP->Connect(
        wxEVT_COMMAND_CHECKBOX_CLICKED,
        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
    rgrTSGFCW_RXTSP->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED,
                             wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    rgrTSGMODE_RXTSP->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    rgrINSEL_RXTSP->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED,
                            wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                            NULL, this);
    rgrTSGFC_RXTSP->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED,
                            wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                            NULL, this);
    cmbDCCORR_AVG->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                           wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                           NULL, this);
    btnLoadDCI->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnLoadDCIClick), NULL,
                        this);
    btnLoadDCQ->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnLoadDCQClick), NULL,
                        this);
    cmbCMIX_SC_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    cmbCMIX_GAIN_RXTSP->Connect(
        wxEVT_COMMAND_COMBOBOX_SELECTED,
        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
    cmbHBD_OVR_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    cmbHBD_DLY->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                        wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL,
                        this);
    cmbGFIR1_L_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    cmbGFIR1_N_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                              wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    btnGFIR1Coef->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(lms7002_pnlRXTSP_view::onbtnGFIR1Coef), NULL, this);
    cmbGFIR2_L_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    cmbGFIR2_N_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                              wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    btnGFIR2Coef->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(lms7002_pnlRXTSP_view::onbtnGFIR2Coef), NULL, this);
    cmbGFIR3_L_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    cmbGFIR3_N_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                              wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    btnGFIR3Coef->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(lms7002_pnlRXTSP_view::onbtnGFIR3Coef), NULL, this);
    txtLPFBW->Connect(
        wxEVT_MOUSEWHEEL,
        wxMouseEventHandler(lms7002_pnlRXTSP_view::txtFCWPHOmodeAdditional_OnMouseWheel), NULL,
        this);
    btnSetLPF->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(lms7002_pnlRXTSP_view::OnbtnSetLPFClick), NULL, this);
    cmbIQCORR_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                             wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    cmbGCORRI_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                             wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    cmbGCORRQ_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                             wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    cmbAGC_MODE_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                               wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                               NULL, this);
    cmbAGC_AVG_RXTSP->Connect(wxEVT_COMMAND_COMBOBOX_SELECTED,
                              wxCommandEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                              NULL, this);
    spinAGC_K_RXTSP->Connect(wxEVT_COMMAND_SPINCTRL_UPDATED,
                             wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler),
                             NULL, this);
    cmbAGC_ADESIRED_RXTSP->Connect(
        wxEVT_COMMAND_SPINCTRL_UPDATED,
        wxSpinEventHandler(lms7002_pnlRXTSP_view::ParameterChangeHandler), NULL, this);
...
void lms7002_pnlRXTSP_view::onbtnGFIR1Coef(wxCommandEvent &event)
{
    ...
    int status = LMS_GetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR1, &coefficients[0]);
    if (status < 0)
    {
    ...
    if (dlg->ShowModal() == wxID_OK)
    {
        ...
        LMS_SetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR1, &coefficients[0],
                         coefficients.size());
    }
    dlg->Destroy();
    UpdateGUI();
...
void lms7002_pnlRXTSP_view::onbtnGFIR2Coef(wxCommandEvent &event)
{
    ...
    const int maxCoefCount = 40;
    coefficients.resize(maxCoefCount, 0);
    int status = LMS_GetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR2, &coefficients[0]);
    if (status < 0)
    {
        wxMessageBox(_("Error reading GFIR coefficients"), _("ERROR"), wxICON_ERROR | wxOK);
        dlg->Destroy();
    ...
    {
        coefficients = dlg->GetCoefficients();
        LMS_SetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR2, &coefficients[0],
                         coefficients.size());
    }
    dlg->Destroy();
    UpdateGUI();
...
void lms7002_pnlRXTSP_view::onbtnGFIR3Coef(wxCommandEvent &event)
{
    ...
    int status = LMS_GetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR3, &coefficients[0]);
    if (status < 0)
    {
        wxMessageBox(_("Error reading GFIR coefficients"), _("ERROR"), wxICON_ERROR | wxOK);
        dlg->Destroy();
    ...
    {
        coefficients = dlg->GetCoefficients();
        LMS_SetGFIRCoeff(lmsControl, LMS_CH_RX, mChannel, LMS_GFIR3, &coefficients[0],
                         coefficients.size());
    }
    dlg->Destroy();
    UpdateGUI();
...
void lms7002_pnlRXTSP_view::Initialize(SDRDevice *pControl)
{
...
void lms7002_pnlRXTSP_view::OnbtnUploadNCOClick(wxCommandEvent &event)
{
    ...
    if (rgrMODE_RX->GetSelection() == 0)
    {
        ...
        LMS_SetNCOFrequency(lmsControl, LMS_CH_RX, mChannel, nco_freq, value);
    }
    else
    {
        double nco_phase[16];
...
void lms7002_pnlRXTSP_view::OnbtnSetLPFClick(wxCommandEvent &event)
{
    ...
    if (LMS_SetGFIRLPF(lmsControl, LMS_CH_RX, mChannel, true, bw * 1e6) != 0)
...
void lms7002_pnlRXTSP_view::UpdateNCOinputs()
{
    ...
    if (rgrMODE_RX->GetSelection() == 0) //FCW mode
    {
        double freq[16] = {0};
        double pho=0;
        LMS_GetNCOFrequency(lmsControl, LMS_CH_RX, mChannel, freq, &pho);
...
void lms7002_pnlRXTSP_view::UpdateGUI()
{
    ...
    double freq = lmsControl->GetClockFreq(LMS_CLOCK_RXTSP, mChannel);
    ...
    double sr = 0;
    LMS_GetSampleRate(lmsControl, LMS_CH_RX, mChannel, &sr, nullptr);
