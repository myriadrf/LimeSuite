...
lms7002_pnlLimeLightPAD_view::lms7002_pnlLimeLightPAD_view(wxWindow *parent, wxWindowID id,
    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    cmbTXTSPCLKA_DIV->Connect(
        ...
        wxSpinEventHandler(lms7002_pnlLimeLightPAD_view::SpinParameterChangeHandler), NULL, this);
