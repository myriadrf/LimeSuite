...
lms7002_pnlRBB_view::lms7002_pnlRBB_view(wxWindow *parent, wxWindowID id, const wxPoint &pos,
    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    sbSizer35 = new wxStaticBoxSizer( new wxStaticBox( sbSizerPowerDowns->GetStaticBox(), wxID_ANY, wxT("Direct control") ), wxVERTICAL );
    ...
    cmbINPUT_CTL_PGA_RBB = new wxComboBox(this, ID_INPUT_CTL_PGA_RBB, wxEmptyString,
    ...
    cmbG_PGA_RBB = new wxComboBox(this, ID_G_PGA_RBB, wxEmptyString, wxDefaultPosition,
    ...
    cmbR_CTL_LPF_RBB = new wxComboBox(sbSizerRCtimeConstants->GetStaticBox(), ID_R_CTL_LPF_RBB,
    ...
    cmbRCC_CTL_LPFH_RBB =
        new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_RCC_CTL_LPFH_RBB, wxEmptyString,
    ...
    cmbRCC_CTL_LPFL_RBB =
        new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_RCC_CTL_LPFL_RBB, wxEmptyString,
                       wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbICT_LPF_IN_RBB = new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_ICT_LPF_IN_RBB,
                                       wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbICT_LPF_OUT_RBB =
        new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_ICT_LPF_OUT_RBB, wxEmptyString,
                       wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbICT_PGA_OUT_RBB =
        new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_ICT_PGA_OUT_RBB, wxEmptyString,
                       wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbICT_PGA_IN_RBB = new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_ICT_PGA_IN_RBB,
                                       wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbRCC_CTL_PGA_RBB =
        new wxComboBox(sbSizerOpAmp->GetStaticBox(), ID_RCC_CTL_PGA_RBB, wxEmptyString,
                       wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
