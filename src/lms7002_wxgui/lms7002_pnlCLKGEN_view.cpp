...
lms7002_pnlCLKGEN_view::lms7002_pnlCLKGEN_view(wxWindow *parent, wxWindowID id, const wxPoint &pos,
    ...
    : ILMS7002MTab(parent, id, pos, size, style)
{
    ...
    cmbTST_CGEN = new wxComboBox(this, ID_TST_CGEN, wxEmptyString, wxDefaultPosition,
                                 wxSize(-1, -1), 0, NULL, 0);
    ...
    cmbCP2_CGEN = new wxComboBox(sbSizer68->GetStaticBox(), ID_CP2_CGEN, wxEmptyString,
    ...
    cmbCP3_CGEN = new wxComboBox(sbSizer68->GetStaticBox(), ID_CP3_CGEN, wxEmptyString,
                                 wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbCZ_CGEN = new wxComboBox(sbSizer68->GetStaticBox(), ID_CZ_CGEN, wxEmptyString,
                                wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
    ...
    cmbCLKH_OV_CLKL_CGEN =
        new wxComboBox(sbSizer70->GetStaticBox(), ID_CLKH_OV_CLKL_CGEN, wxEmptyString,
                       wxDefaultPosition, wxDefaultSize, 0, NULL, 0);
