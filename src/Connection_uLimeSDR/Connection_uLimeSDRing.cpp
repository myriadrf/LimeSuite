...
std::string Connection_uLimeSDR::SetupStream(size_t &streamID, const StreamConfig &config)
{
    streamID = ~0;
...
void Connection_uLimeSDR::CloseStream(const size_t streamID)
{
...
bool Connection_uLimeSDR::ControlStream(const size_t streamID, const bool enable, const size_t burstSize, const StreamMetadata &metadata)
{
    auto *stream = (USBStreamServiceChannel *)streamID;
...
int Connection_uLimeSDR::ReadStream(const size_t streamID, void * const *buffs, const size_t length, const long timeout_ms, StreamMetadata &metadata)
{
    auto *stream = (USBStreamServiceChannel *)streamID;
...
int Connection_uLimeSDR::WriteStream(const size_t streamID, const void * const *buffs, const size_t length, const long timeout_ms, const StreamMetadata &metadata)
{
    auto *stream = (USBStreamServiceChannel *)streamID;
...
*/
	...
	void Connection_uLimeSDR::UpdateExternalDataRate(const size_t channel, const double txRate_Hz, const double rxRate_Hz)
	{
		...
		else
		{
			...
			lime::fpga::SetDirectClocking(this, 0, rxInterfaceClk, 90);
		}
