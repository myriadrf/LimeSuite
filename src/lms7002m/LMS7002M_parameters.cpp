...
const struct LMS7Parameter PD_VCO_CGEN = { 0x0086, 2, 2, 1, "PD_VCO_CGEN", "Power down for VCO" };
...
const struct LMS7Parameter ICT_VCO_CGEN = { 0x008B, 13, 9, 128, "ICT_VCO_CGEN", "Scales the VCO bias current from 0 to 2.5xInom" };
...
const struct LMS7Parameter PD_LDO_SPIBUF = { 0x00A6, 3, 3, 0, "PD_LDO_SPIBUF", "Enables the LDO" };
const struct LMS7Parameter PD_LDO_DIGIp2 = { 0x00A6, 2, 2, 0, "PD_LDO_DIGIp2", "Enables the LDO" };
const struct LMS7Parameter PD_LDO_DIGIp1 = { 0x00A6, 1, 1, 0, "PD_LDO_DIGIp1", "Enables the LDO" };
...
const struct LMS7Parameter ICT_IAMP_FRP_TBB = { 0x0108, 9, 5, 12, "ICT_IAMP_FRP_TBB", "This controls the reference bias current of the IAMP main bias current sources" };
const struct LMS7Parameter ICT_IAMP_GG_FRP_TBB = { 0x0108, 4, 0, 12, "ICT_IAMP_GG_FRP_TBB", "This controls the reference bias current of the IAMP's cascode transistors gate voltages that set the IAMP's input voltage level. The IAMP's input is connected to the DAC output" };
...
const struct LMS7Parameter ICT_TIAMAIN_RFE = { 0x010F, 9, 5, 12, "ICT_TIAMAIN_RFE", "Controls the reference current of the RXFE TIA first stage" };
const struct LMS7Parameter ICT_TIAOUT_RFE = { 0x010F, 4, 0, 12, "ICT_TIAOUT_RFE", "Controls the reference current of the RXFE TIA 2nd stage" };
...
const struct LMS7Parameter ICT_LNA_RFE = { 0x0110, 9, 5, 12, "ICT_LNA_RFE", "Controls the current of the LNA core" };
...
const struct LMS7Parameter ICT_VCO = { 0x0120, 7, 0, 128, "ICT_VCO", "Scales the VCO bias current from 0 to 2.5xInom" };
const struct LMS7Parameter RSEL_LDO_VCO = { 0x0121, 15, 11, 16, "RSEL_LDO_VCO", "Set the reference voltage that supplies bias voltage of switch-cap array and varactor" };
...
const struct LMS7Parameter IOFFSET_CP = { 0x0122, 11, 6, 20, "IOFFSET_CP", "Scales the offset current of the charge pump, 0-->63. This current is used in Fran-N mode to create an offset in the CP response and avoid the non-linear section" };
const struct LMS7Parameter IPULSE_CP = { 0x0122, 5, 0, 20, "IPULSE_CP", "Scales the pulse current of the charge pump" };
